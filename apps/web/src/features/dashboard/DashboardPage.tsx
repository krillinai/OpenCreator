...
export function DashboardPage() {
  ...
  return <main className="dashboard-page"><div className="dashboard-page__inner">
    <header className="dashboard-header"><div><div className="dashboard-title-row"><h1>数据看板</h1><span>静态示例</span></div><p>企业 Agent 运行与知识资产概览</p></div><div className="dashboard-period"><span>统计周期</span><strong>近 7 天</strong></div></header>
    <div className="dashboard-notice" role="note">静态示例数据，暂未连接企业服务</div>
