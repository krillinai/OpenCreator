...
export const activitySnapshots: Record<ActivityRange, ActivitySnapshot> = {
  ...
  '7d': {
    ...
    agents: [
      ...
      agent({ collectorId: 'collector-shanghai', agentId: 'agent-code-review', employeeName: '林夏', name: '代码审查', workspace: '~/develop/opencreator-client', usage: { inputTokens: 7_480, cachedInputTokens: 3_120, outputTokens: 2_380, reasoningOutputTokens: 940 }, completedTurns: 4, sessionCount: 1, sessionTitle: '检查工作区变更', promptSummary: '检查当前工作区的前端变更', assistantSummary: '已标记 2 项可维护性建议', toolName: 'ReadFile', subagentName: '测试检查' }),
